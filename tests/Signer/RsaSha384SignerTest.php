...
class RsaSha384SignerTest extends BaseCase
{
    public function testUpdateJoseParams(): void
    {
        ...
        $awaitedJose = ['test' => 'test value', JoseHeaderParams::ALG->value => 'RS384'];

        $public = $this->getPublicKey();
        $private = $this->getPrivateKey();

        $signer = new RsaSha384Signer($public, $private);
    ...
    public function testCreateSignature(): void
    {
        ...
        $awaitedSignature = file_get_contents(__DIR__ . '/_fixtures/RsaSha384SignerTest_signature.txt');
    ...
    public function testCreateSignatureWrongKeyException(): void
    {
        ...
        $signer = new RsaSha384Signer($private, $public);
    ...
    private function getPublicKey(): Secret
    {
        ...
        $public->method('getSecret')->willReturn(
            file_get_contents(__DIR__ . '/_fixtures/RsaSha384SignerTest_public.key')
        );
    ...
    private function getPrivateKey(): Secret
    {
        ...
        $private->method('getSecret')->willReturn(
            file_get_contents(__DIR__ . '/_fixtures/RsaSha384SignerTest_private.key')
        );
