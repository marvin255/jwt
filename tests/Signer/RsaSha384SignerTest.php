...
class RsaSha384SignerTest extends BaseCase
{
    public function testUpdateJoseParams(): void
    {
        ...
        $awaitedJose = ['test' => 'test value', JoseHeader::ALG => 'RS384'];

        $public = new SecretFile(__DIR__ . '/_fixtures/RsaSha384SignerTest_public.key');
        $private = new SecretFile(__DIR__ . '/_fixtures/RsaSha384SignerTest_private.key');
